...
function TranslationOverlay() {
  ...
  return (
    <>
      <div className="fixed bottom-4 right-4 z-50 p-4 bg-white/95 backdrop-blur shadow-2xl rounded-xl border-2 border-[#0B162A] w-80">
        <h3 className="font-bold text-[#0B162A] mb-2">Instant French Translator</h3>
        <textarea
          className="w-full p-2 border border-gray-300 rounded mb-2 text-sm text-gray-900 bg-white focus:border-[#C83803] focus:ring-[#C83803]"
          rows={3}
          placeholder="Type text to overlay..."
          value={text}
          onChange={(e) => setText(e.target.value)}
        />
        {loading && <p className="text-xs text-gray-500">Translating...</p>}
        {translation && (
          <div className="mt-2 p-2 bg-[#0B162A]/5 rounded border border-[#0B162A]/10">
      ...
      {translation && (
        <div className="fixed inset-0 pointer-events-none flex items-center justify-center z-[100]">
           <h1 className="text-6xl font-black text-[#C83803] drop-shadow-[0_4px_4px_rgba(11,22,42,0.5)] text-center px-4 leading-tight bg-white/10 backdrop-blur-sm p-8 rounded-3xl border-4 border-[#0B162A]">
             {translation}
           </h1>
        </div>
      )}
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 justify-between">
              <div className="flex">
                <div className="flex shrink-0 items-center">
                  <Link href="/" className="flex items-center space-x-3">
                    ...
                    />
                    <span className="text-2xl font-bold" style={{ color: '#0B162A' }}>
                      tPBM Protocols
                    </span>
                  </Link>
                </div>
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  {showItems.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-600 hover:border-[#C83803] hover:text-gray-900 transition-colors"
                    >
                      {item.name}
                    </a>
                  ))}
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
                {!memberLoading && member ? (
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-1">
                      <button
                        ...
                        className="flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0B162A]"
                      >
                        {avatarUrl ? (
                          <img
                            src={avatarUrl}
                          ...
                          <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#0B162A] via-[#C83803] to-[#0B162A] animate-pulse" />
                        ) : (
                          <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#0B162A] via-[#C83803] to-[#0B162A] flex items-center justify-center text-white text-xs font-semibold">
                  ...
                  <>
                    ...
                    <a
                      href="#pricing"
                      className="rounded-md bg-[#0B162A] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#C83803] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0B162A] transition-colors"
                    >
                      Get Started
                    </a>
                  </>
              ...
              <div className="-mr-2 flex items-center sm:hidden">
                <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#0B162A]">
            ...
            <div className="space-y-1 pb-3 pt-2">
              ...
              {!memberLoading && member ? (
                <DisclosureButton
                  as="a"
                  href="/clients"
                  className="block border-l-4 border-[#0B162A] py-3 pl-3 pr-4 text-lg font-bold text-white bg-[#0B162A] hover:bg-[#C83803] mx-3 my-2 rounded-md"
                >
                  📊 Dashboard
                </DisclosureButton>
              ) : !memberLoading ? (
        ...
        <div className="relative bg-gradient-to-br from-[#0B162A]/5 via-white to-[#C83803]/5 pt-16">
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
              ...
              <div className="w-full lg:w-1/2 order-1 lg:order-1">
                ...
                <div className="hidden lg:flex flex-col sm:flex-row gap-4 mt-10">
                  <a
                    href="#features"
                    className="rounded-md bg-[#0B162A] px-6 py-3 text-lg font-semibold text-white shadow-sm hover:bg-[#C83803] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0B162A] transition-colors text-center"
                  >
                    See How It Works
                  </a>
                  <a
                    href="#pricing"
                    className="rounded-md bg-white px-6 py-3 text-lg font-semibold text-[#0B162A] shadow-sm ring-1 ring-inset ring-[#0B162A] hover:bg-gray-50 transition-colors text-center"
                  >
              ...
              <div className="relative w-full lg:w-1/2 order-2 lg:order-2">
                <div className="relative w-full pb-[56.25%] rounded-2xl shadow-2xl ring-1 ring-[#0B162A]/10 overflow-hidden bg-gray-900">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center z-20">
                      <div className="w-20 h-20 rounded-full bg-white/90 flex items-center justify-center group-hover:bg-white group-hover:scale-110 transition-all duration-200 shadow-xl">
                        <svg className="w-10 h-10 text-[#0B162A] ml-1" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <ul className="mt-8 space-y-4">
                  <li className="flex items-start">
                    <CheckIcon className="h-6 w-6 text-[#0B162A] shrink-0 mt-1" />
        ...
        <div className="bg-gradient-to-br from-[#0B162A]/5 via-[#C83803]/5 to-white py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center">
              {/* Left Column - Content Cards */}
              <div>
                <div className="inline-block mb-4 rounded-full bg-[#0B162A]/10 px-4 py-2">
                  <p className="text-sm sm:text-base font-semibold text-[#0B162A]">Exclusive Early Access</p>
                </div>
                ...
                <div className="mb-6 rounded-xl bg-white p-6 shadow-md ring-1 ring-[#0B162A]/20 hover:shadow-lg transition-shadow">
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-[#0B162A]">
                ...
                <div className="rounded-xl bg-white p-6 shadow-md ring-1 ring-[#0B162A]/20 hover:shadow-lg transition-shadow">
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-[#0B162A]">
                        <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8">
              ...
              <div className="relative">
                ...
                <div className="text-center lg:text-left">
                  <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#0B162A] text-white text-xl font-bold mb-4">
                    1
                  </div>
        ...
        {/* The Results Section */}
        <div id="science" className="relative bg-gradient-to-br from-[#0B162A]/5 via-[#C83803]/5 to-[#0B162A]/5 py-16 sm:py-24 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              ...
              <div className="relative lg:mt-32">
                <div className="aspect-[4/3] w-full overflow-hidden rounded-2xl shadow-2xl ring-1 ring-[#0B162A]/10 lg:sticky lg:top-32">
                  <img
              ...
              <div className="space-y-6">
                <div className="flex gap-4 bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-md ring-1 ring-gray-200 hover:shadow-lg transition-shadow">
                  <div className="flex-shrink-0">
                    <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-[#0B162A] text-white text-xl font-bold">
                      1
                    </div>
                  </div>
                  <div>
        ...
        <div id="pricing" className="bg-gray-50 py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-4xl text-center mb-12 rounded-2xl bg-gradient-to-br from-[#0B162A]/5 to-[#C83803]/5 p-8 shadow-md ring-1 ring-[#0B162A]/20">
              ...
              <p className="text-lg sm:text-xl font-semibold text-[#0B162A] mb-4">
              ...
              <div className="space-y-8 lg:col-span-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-5">
                    <div className="sm:col-span-3 p-6 flex flex-col items-center">
                      ...
                      <button
                        ...
                        className="mt-5 rounded-md bg-[#0B162A] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#C83803]"
                      >
                        Buy Neuronics LIGHT
                      </button>
                    </div>
                    <div className="sm:col-span-2 p-6 flex flex-col">
                      <p className="text-sm font-semibold text-[#0B162A] uppercase tracking-wide">Neuronics Light Package</p>
                      ...
                      <ul className="mt-4 space-y-2">
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Reliable, full-coverage near-infrared stimulation</span></li>
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Enhanced cerebral blood flow and mitochondrial activation</span></li>
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Unlimited client usability</span></li>
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Direct drop-shipping to your office or patient's home</span></li>
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Designed for everyday use and simple setup</span></li>
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Ideal for providers offering patients an affordable at-home training option</span></li>
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Supports focus, emotional balance, and stress resilience</span></li>
                      </ul>
                ...
                <div className="bg-white rounded-2xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
                  <div className="grid grid-cols-1 sm:grid-cols-5">
                    ...
                    <div className="sm:col-span-2 p-6 flex flex-col">
                      <p className="text-sm font-semibold text-[#0B162A] uppercase tracking-wide">Neuronics Neuroradiant 1070 Package</p>
                      ...
                      <ul className="mt-4 space-y-2">
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Research-grade tPBM technology for in-office use</span></li>
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Targeted 1070 nm near-infrared stimulation reaching deeper brain structures</span></li>
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Enhanced cerebral blood flow and mitochondrial activation</span></li>
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Optimized for clinical and high-performance applications</span></li>
                        <li className="flex items-start"><CheckIcon className="h-5 w-5 text-[#0B162A] mt-0.5" aria-hidden="true" /><span className="ml-3 text-sm text-gray-700">Engineered for reliability, repeatability, and precision control</span></li>
                      </ul>
                      <div className="mt-4 rounded-lg bg-gray-50 p-4">
                        <p className="text-xs font-semibold text-gray-900 uppercase tracking-wide mb-2">Best Fit</p>
              ...
              <div className="lg:col-span-1">
                <div className="lg:sticky lg:top-24 self-start bg-white rounded-2xl shadow-sm ring-1 ring-gray-200 overflow-hidden flex flex-col">
                  ...
                  <div className="p-5 flex flex-col">
                    <p className="text-sm font-semibold text-[#0B162A] uppercase tracking-wide">QEEG-Driven Protocol Subscription Package</p>
                    ...
                    <div className="mt-6 space-y-3">
                      {/* Monthly Option */}
                      <div className="rounded-lg border-2 border-gray-300 p-4 hover:border-[#0B162A] transition-colors">
                        ...
                        <a 
                          ...
                          className="block w-full text-center rounded-md bg-white border-2 border-[#0B162A] px-4 py-2 text-sm font-semibold text-[#0B162A] hover:bg-[#C83803] hover:text-white transition-colors"
                        >
                          Subscribe Monthly
                        </a>
                      </div>
                      ...
                      {/* Annual Option */}
                      <div className="rounded-lg border-2 border-[#0B162A] p-4 bg-[#0B162A]/5 relative">
                        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                          <span className="bg-[#0B162A] text-white text-xs font-semibold px-3 py-1 rounded-full whitespace-nowrap">
                            BEST VALUE - Save $80
                          </span>
                        </div>
                        ...
                        <a 
                          ...
                          className="block w-full text-center rounded-md bg-[#0B162A] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#C83803] transition-colors"
                        >
                          Subscribe Annually
                        </a>
                      </div>
        ...
        <div className="bg-white py-16 sm:py-24">
          <div className="mx-auto max-w-3xl px-6 lg:px-8 text-center">
            ...
            <div className="mt-10">
              <button
                ...
                className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-[#0B162A] shadow-sm ring-1 ring-inset ring-[#0B162A] hover:bg-[#0B162A]/5 transition-colors"
              >
                Contact Us
              </button>
            </div>
          ...
          <div className="mx-auto max-w-4xl px-6 lg:px-8 mt-16">
            <div className="rounded-2xl bg-gradient-to-br from-[#0B162A]/5 to-[#C83803]/5 p-8 shadow-lg ring-1 ring-[#0B162A]/20">
                ...
                {({ open }) => (
                  <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    <DisclosureButton className="flex w-full items-center justify-between px-4 py-4 text-left">
                      ...
                      <ChevronDownIcon className={`h-5 w-5 text-[#0B162A] transition-transform ${open ? 'rotate-180' : ''}`} />
                    </DisclosureButton>
                    <DisclosurePanel className="px-4 pb-4 pt-2 space-y-4 border-t border-gray-100">
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Unlimited client usability</span></div>
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Direct drop‑shipping to office or patient's home</span></div>
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Designed for everyday use and simple setup</span></div>
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Full‑coverage stimulation across the scalp</span></div>
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Enhanced cerebral blood flow and mitochondrial activation</span></div>
                        </div>
                      </div>
                      <div>
                  ...
                  <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <DisclosurePanel className="px-4 pb-4 pt-2 space-y-4 border-t border-gray-100">
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-gray-700 mb-2">Includes</h4>
                        <div className="space-y-2">
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Research‑grade tPBM for in‑office use</span></div>
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Targeted 1070 nm stimulation reaching deeper structures</span></div>
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Enhanced cerebral blood flow and mitochondrial activation</span></div>
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Engineered for reliability, repeatability, and precision control</span></div>
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">4‑Quadrant control with precision targeting</span></div>
                        </div>
                      </div>
                      <div>
                        <h4 className="text-sm font-semibold text-gray-700 mb-1">Best For</h4>
                  ...
                  <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <DisclosurePanel className="px-4 pb-4 pt-2 space-y-4 border-t border-gray-100">
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-gray-700 mb-2">Includes</h4>
                        <div className="space-y-2">
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Unlimited QEEG uploads</span></div>
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">Unlimited clients</span></div>
                          <div className="flex items-start"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0 mt-0.5" /><span className="text-sm text-gray-600">All protocol updates included</span></div>
                        </div>
                      </div>
                      <div>
                        <h4 className="text-sm font-semibold text-gray-700 mb-1">Best For</h4>
              ...
              <table className="min-w-full divide-y divide-gray-200 bg-white">
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700">
                      <div className="space-y-1">
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Unlimited client usability</span></div>
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Direct drop‑shipping to office or patient's home</span></div>
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Designed for everyday use and simple setup</span></div>
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Full‑coverage stimulation across the scalp</span></div>
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Enhanced cerebral blood flow and mitochondrial activation</span></div>
                      </div>
                    </td>
                  ...
                  <tr className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700">
                      <div className="space-y-1">
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Research‑grade tPBM for in‑office use</span></div>
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Targeted 1070 nm stimulation reaching deeper structures</span></div>
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Enhanced cerebral blood flow and mitochondrial activation</span></div>
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Engineered for reliability, repeatability, and precision control</span></div>
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>4‑Quadrant control with precision targeting</span></div>
                      </div>
                    </td>
                  ...
                  <tr className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700">
                      <div className="space-y-1">
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Unlimited QEEG uploads</span></div>
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>Unlimited clients</span></div>
                        <div className="flex items-center"><CheckIcon className="h-4 w-4 text-[#0B162A] mr-2 shrink-0" /><span>All protocol updates included</span></div>
                      </div>
                    </td>
          ...
          <div className="px-6 py-16 sm:px-6 sm:py-24 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="#pricing"
                  className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-[#0B162A] shadow-sm hover:bg-indigo-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                >
                  Get Started Today
                </a>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="block w-full rounded-md border-gray-300 shadow-sm focus:border-[#0B162A] focus:ring-[#0B162A] px-4 py-2 border"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="block w-full rounded-md border-gray-300 shadow-sm focus:border-[#0B162A] focus:ring-[#0B162A] px-4 py-2 border resize-none"
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      ...
                      className="flex-1 rounded-md bg-[#0B162A] px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#C83803] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0B162A] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
